            ...
            <>
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        <h3 class="text-base font-semibold leading-6" id="modal-title">Delete card</h3>
                        <div class="mt-2">
                            <p class="text-sm ">Are you sure you want to delete {editCard.title}? This action cannot be undone.</p>
                        </div>
                    </div>
                </div>
